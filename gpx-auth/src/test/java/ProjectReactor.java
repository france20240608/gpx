...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.gpx";
    private static final String ARTIFACT_ID = "gpx";
    private static final String PACKAGE_NAME = "com.gpx";
    private static final String TITLE = "GPX管理系统";
    ...
    public static void main(String[] args) {
        ...
        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "com.gpx";
        String artifactIdNew = "gpx";
        String packageNameNew = "com.gpx";
        String titleNew = "GPX管理系统";
        String projectBaseDirNew = projectBaseDir.replace(ARTIFACT_ID, artifactIdNew); // 一键改名后，“新”项目所在的目录
